      ...
      <div className="flex  flex-col items-center  justify-between md:justify-center  sm:justify-center lg:grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 w-full">
        ...
        <div className="flex  items-center lg:justify-end justify-center w-full">
          <div className="flex flex-col gap-8">
            <h2 className="lg:text-left text-center text-[#000000] lg:text-[40px]   sm:text-[32px] md:text-[32px]   font-[400px] lg:leading-[56px] leading-[40px]">
              We connect our customers <br />with the best, and help them <br />keep up-and stay open.
            </h2>

            <ul className=" flex flex-col gap-4 list-none mt-4  lg:mb-0 md:mb-0 md:mb-8 mb-8 text-[#000000] lg:text-[22px] sm:text-[18px] md:text-[18px]  font-sans font-[400px] leading-[40px]">
              <li className=" flex items-center lg:justify-start md:justify-center  gap-x-4 cursor-pointer"> <img src={Image.Good} alt="logo" className="" /><span >We connect our customers with the best. </span> </li>
